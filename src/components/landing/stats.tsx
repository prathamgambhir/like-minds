...
export default function StatsSection() {
  ...
  return (
    <section className="relative w-full py-12 bg-zinc-50 border-b border-zinc-100">
          ...
          {stats.map((stat) => {
            ...
            return (
              ...
              >
                <div>
                  {/* Icon */}
                  <div className={`h-10 w-10 rounded-xl flex items-center justify-center mb-4 ${stat.colorClass}`}>
